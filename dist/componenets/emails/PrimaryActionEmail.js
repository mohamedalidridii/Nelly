...
const EmailTemplate = ({ actionLabel, buttonText, href, }) => {
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Cabinet Rym Gamra"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Img, { src: `${process.env.NEXT_PUBLIC_SERVER_URL}/hippo-newsletter-sign-up.png`, width: '150', height: '150', alt: 'no', style: logo }),
                React.createElement(components_1.Text, { style: paragraph }, "Hi there,"),
                React.createElement(components_1.Text, { style: paragraph },
                    "Welcome to Rym Gamra&pos;s Website. Use the button below to ",
                    actionLabel,
                    "."),
