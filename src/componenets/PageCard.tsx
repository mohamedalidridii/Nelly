    ...
    return <>
      ...
      <section className="flex flex-row w-full h-screen">
        ...
        <div className="group relative w-1/2 h-full overflow-hidden">
          ...
          />
          <Link href='/about' className="absolute inset-0 flex items-center justify-center text-white text-lg font-bold bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
